...
The LLM was really helpful in keeping me from resuming training too fast. Since that pause the training feels easier and my body has adapted quite well to the volume. I also picked up [Runalyze](https://runalyze.com), a running analytics platform, to track my runs and overall progress — it put my [effective VO2max](https://runalyze.com/help/article/vo2max) at ~45, while my Apple Watch was reading ~52.5.
...
![Race overview for the April 5k benchmark run](/images/april-benchmark-result.png)
