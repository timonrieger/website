...
def get_all_highlights():
    response = requests.get(
        f"{readwise_base_url}/v2/highlights/",
        params={"page_size": 1000, "page": 1},
...
def ask_ai(text):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {
                "role": "assistant",
                "content": "Find the author of the quote. Then output the quote and the author in the following format to stdout: 'quote' - author",
            },
